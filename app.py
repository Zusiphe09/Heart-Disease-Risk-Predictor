...
if page == "Heart Disease Predictor":
    ...
    if st.button(
        ...
        st.success(
            "Patient prediction has been saved successfully."
        )
...
# ============================================================
    ...
    st.write(
        "View previously recorded heart disease predictions."
    )
    ...
    if os.path.exists(
        ...
        if records.empty:
            ...
            positive_records = len(
                records[
                    records["Prediction"] == "Positive"
                ]
            )


            negative_records = len(
                records[
                    records["Prediction"] == "Negative"
                ]
            )
